...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mongodb' => [
            'driver' => 'mongodb',
            'host' => env('MDB_DB_HOST', '127.0.0.1'),
            'port' => env('MDB_DB_PORT', 27017),
            'database' => env('MDB_DB_DATABASE', 'homestead'),
            'username' => env('MDB_DB_USERNAME', ''),
            'password' => env('MDB_DB_PASSWORD', ''),
            'options' => [
