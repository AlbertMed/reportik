        <tr>
            ...
            <td style="width:15%">$ {{number_format($acumuladosxcta[$rep->BC_Cuenta_Id],'2', '.',',')}}</td>
            <td style="width:10%">{{($acumulados_hoja2[$rep->RGC_tabla_titulo] == 0) ? '0' :number_format(($acumuladosxcta[$rep->BC_Cuenta_Id] / $acumulados_hoja2[$rep->RGC_tabla_titulo]) * 100 ,'2', '.',',')}}%</td>
        </tr>
