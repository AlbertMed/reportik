...
<div class="" id="page"><!-- group -->
    ...
    <div class="row" ><!-- column -->
        <p align="center"  ><!-- svg -->
            <img class="svg hidden-xs" id="u196" src={{ URL::asset('images/150982x45_poster.png') }} alt="" data-mu-svgfallback="/siz/public/images/svg%20pegado%20150982x45_poster_.png?crc=4279418901" width="200" height="200"
           />
            ...
            <div >
                <div class="col-md-4 col-xs-8 col-xs-offset-2 col-md-offset-4">
                    ...
                    <div>                                                                                                    
                        ...
                        <input type="text" min="0" id="userId" name="userId" value="{{Auth::user()->nomina}}" hidden>
                                                <br><font size="5" style="color: white"><p align="center" class="courier">Hola {{Auth::user()->name}}</p></font> <br>
