                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-md-offset-1 col-xs-5">
                                    ...
                                    <div id="hiddendiv">
                                        ...
                                        <input autofocus id="miusuario" type="number" class="form-control" name="miusuario" required minlength="3" maxlength="5">
                                        <label for="pass" class="control-label">Contraseña:</label>
                                    <input id="pass" type="password" class="form-control" name="pass" required minlength="3" maxlength="10" value="{{Session::get('Rec_pass')}}">
                                    <br>
                                    </div>
