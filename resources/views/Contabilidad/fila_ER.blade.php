...
<!--  -->          
           ...
           <td>0.00 %</td>
           @else
                <td style="width:13%">$ {{number_format($acumuladosxcta_p[$rep->BC_Cuenta_Id.$rep->RGC_BC_Cuenta_Id2] -
                    $rep->movimiento_p,'2', '.',',')}}
                </td>
                <!-- porcentaje -->
            ...
            <!-- Acumulado -->
            <td style="width:13%">$ {{number_format($acumuladosxcta_p[$rep->BC_Cuenta_Id.$rep->RGC_BC_Cuenta_Id2],'2', '.',',')}}</td>
            <!-- porcentaje -->
...
<!-- -->
            ...
            <!-- Acumulado -->
            <td style="width:13%">$ {{number_format($acumuladosxcta_p[$rep->BC_Cuenta_Id.$rep->RGC_BC_Cuenta_Id2] - $acumuladosxcta[$rep->BC_Cuenta_Id.$rep->RGC_BC_Cuenta_Id2],'2', '.',',')}}
            </td>
